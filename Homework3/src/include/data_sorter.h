...
class DataSorter {
 public:
   ...
   * @return true if sort successfully
   */
  static auto SortSingleFile(const std::filesystem::directory_entry &file) -> bool;
   ...
   */
  static auto MergeTwoFiles(const std::string &file_path_1, const std::string &file_path_2) -> bool;
